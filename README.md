...
Part I: The Perceptron: Implementation of a single-layer perceptron to classify data generated from two Gaussian distributions.
...
Part III: Optimization: Implemented Stochastic Gradient Descent (SGD) and compared its performance against Batch Gradient Descent.
...
Part I: PyTorch MLP: Re-implemented the MLP architecture from Assignment 1 using PyTorch to compare accuracy against the NumPy version.
...
Navigate to the specific assignment folder (e.g., Assignment_1) and launch Jupyter:
